...
public class MultiActionStateSMB : StateMachineBehaviour
{
    [Header("Player Capabilities")]
    [SerializeField] private bool lockMovement = false;
    [SerializeField] private bool restoreMovementOnExit = true;
    ...
    override public void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        if (restoreMovementOnExit) player.SetMovement(true);
        player.SetInvincible(false);
